...
Create groups: choose a name, color weather it is a main sound or an effect. Main sounds constantly play, for example, a 3-minute file of crickets, and an effect group is for something like thunder. You can have multiple files, and they will be picked at random. You can choose when this happens
